...
let AKFeed = [], AZFeed = [], CTFeed = [], DEFeed = [], FLFeed = [], GAFeed = [], IAFeed = [], ILFeed = [], INFeed = [], LAFeed = [], MDFeed = [], MIFeed = [], MNFeed = [], NCFeed = [], NJFeed = [], NVFeed = [], NYFeed = [], OHFeed = [], ORFeed = [], PAFeed = [], TXFeed = [], VAFeed = [], WAFeed = [], WIFeed = [], WV;
let settings;
let mapBounds;
let state, stateLength, advisories;
const updateMessage = "&#9658; Added IA";
...
(function () {
    ...
    const config = { //Configuration data for each state
        ...
        IA: {
            ...
            URL: ['http://scripts.essentialintegrations.com/IA']
        },
        IL: {
            data(res, index) {

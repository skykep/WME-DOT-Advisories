...
let AKDOTLayer, AZDOTLayer, CTDOTLayer, DEDOTLayer, FLDOTLayer, GADOTLayer, IADOTLayer, ILDOTLayer, INDOTLayer, LADOTLayer, MDDOTLayer, MIDOTLayer, MNDOTLayer, NCDOTLayer, NJDOTLayer, NVDOTLayer, NYDOTLayer, OHDOTLayer, ONDOTLayer, ORDOTLayer, PADOTLayer, TXDOTLayer, VADOTLayer, WADOTLayer, WIDOTLayer, WVDOTLayer;
let promisesAK, promisesAZ, promisesCT, promisesDE, promisesFL, promisesGA, promisesIA, promisesIL, promisesIN, promisesLA, promisesMD, promisesMI, promisesMN, promisesNC, promisesNJ, promisesNV, promisesNY, promisesOH, promisesON, promisesOR, promisesPA, promisesTX, promisesVA, promisesWA, promisesWI, promisesWV;
let advisoriesAK, advisoriesAZ, advisoriesCT, advisoriesDE, advisoriesFL, advisoriesGA, advisoriesIA, advisoriesIL, advisoriesIN, advisoriesLA, advisoriesMD, advisoriesMI, advisoriesMN, advisoriesNC, advisoriesNJ, advisoriesNV, advisoriesNY, advisoriesOH, advisoriesON, advisoriesOR, advisoriesPA, advisoriesTX, advisoriesVA, advisoriesWA, advisoriesWI, advisoriesWV;
let AKFeed = [], AZFeed = [], CTFeed = [], DEFeed = [], FLFeed = [], GAFeed = [], IAFeed = [], ILFeed = [], INFeed = [], LAFeed = [], MDFeed = [], MIFeed = [], MNFeed = [], NCFeed = [], NJFeed = [], NVFeed = [], NYFeed = [], OHFeed = [], ONFeed = [], ORFeed = [], PAFeed = [], TXFeed = [], VAFeed = [], WAFeed = [], WIFeed = [], WVFeed = [];
let endpointsLayer;
...
(function () {
    ...
    function loadSettings() {
        ...
        if (!document.getElementById('dot-advisories-power-btn')) {
            $('a[href="#sidepanel-dotadvisories"]').prepend(
                $('<span>', {
    ...
    const config = { //Configuration data for each state
        ...
        ON: {
            ...
            scheme(obj, index) {
                promisesON.push(new Promise((resolve, reject) => {
                    advisoriesON.push({
                        state: ['ON', 'Ontario'],
                        id: obj.ID,
                        popupType: 0,
                        ...
                        lat: obj.Latitude,
                        type: obj.EventType,
                        keyword: ['roadwork', 'closures', 'accidentsAndIncidents'], //keywords for roadwork/construction
                        desc: obj.Description,
                        time: moment(new Date(obj.LastUpdated * 1000)).format('LLL'),

...
const updateMessage = "&#9658; Fixed issue with reloading advisories with WME refresh button";
...
(function () {
    ...
    function init() {
        ...
        $section.html([
            ...
            '</div><br>',
            '<table border=1 style="text-align:center;width:100%;padding:10px;">',
            '<tr><td width=80 style="text-align:center"><b>Enable</b></td><td style="text-align"><b>State</b></td><td width=30><b>Rpt</b></td></tr>',
    ...
    getFeed("http://40.121.218.107:8080/CSS", function (result) {

...
let AKDOTLayer, DEDOTLayer, FLDOTLayer, GADOTLayer, LADOTLayer, MDDOTLayer, MIDOTLayer, NCDOTLayer, NJDOTLayer, NYDOTLayer, OHDOTLayer, ORDOTLayer, PADOTLayer, WADOTLayer;
let promisesAK, promisesDE, promisesFL, promisesGA, promisesLA, promisesMD, promisesMI, promisesNC, promisesNJ, promisesNY, promisesOH, promisesOR, promisesPA, promisesWA;
let advisoriesAK, advisoriesDE, advisoriesFL, advisoriesGA, advisoriesLA, advisoriesMD, advisoriesMI, advisoriesNC, advisoriesNJ, advisoriesNY, advisoriesOH, advisoriesOR, advisoriesPA, advisoriesWA;
var settings;
var state, stateLength, advisories;
const updateMessage = "&#9658; Added GA (currently unfiltered)";
